...
/*MODEL HEADER*/
/*
 This file contains Slow Corner delays for the design using part EP4SE530F43C2ES
 with speed grade 2, core voltage 0.95V, and temperature 85 Celsius

*/
MODEL_VERSION "1.0";
DESIGN "alf_5x5";
DATE "05/27/2014 16:42:31";
PROGRAM "Quartus II";
